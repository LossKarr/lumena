            ...
            if action.action_type == ActionType.FINAL_ANSWER:
                ...
                if self._task_plan:
                    ...
                    _HALLUCINATION_PATTERNS = [
                        ...
                        (r"\bc[''`]est (fait|configuré|planifié|enregistré|créé)\b", ["create_task", "write_file", "send_message", "discord_create_channel", "generate_website", "serve_website", "edit_website", "create_pdf", "create_docx", "create_pptx", "create_xlsx", "create_invoice_pdf", "create_from_template"]),
