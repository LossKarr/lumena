...
- Google : Gemini 3.6 Flash, Gemini 3.5 Flash/Lite, Gemini 3.1, Gemini 2.5
- Moonshot : Kimi K2.7 Code, Kimi K2.6
- xAI : Grok 4.6, Grok 4.5, Grok 4.3, Grok Build, Grok 4.20
...
AVAILABLE_MODELS: Dict[str, ModelConfig] = {
    ...
    "claude-opus-5": ModelConfig(
        ...
        cost_per_million_tokens=5.0,
        description="Claude Opus 5 — agentic coding et travail complexe, 1M contexte, 128K sortie, vision, outils et adaptive thinking par défaut",
        badge="New",
    ...
    "claude-sonnet-5": ModelConfig(
        ...
        description="Claude Sonnet 5 — successeur Sonnet 4.6, 1M context, 128K output, vision, tools et adaptive thinking par défaut",
        badge="New",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling", "computer_use", "dom_assist", "reasoning", "long_context"}),
    ),
    ...
    "gemini-3.6-flash": ModelConfig(
        ...
        display_name="Gemini 3.6 Flash (Google)",
        provider=ProviderType.GOOGLE,
        ...
        description="Gemini 3.6 Flash — agentique, multimodal et code, 1M contexte (sortie $7.50/M)",
        badge="Nouveau",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling", "reasoning", "long_context", "code_generation"}),
    ),
    "gemini-3.5-flash-lite": ModelConfig(
        name="gemini-3.5-flash-lite",
        display_name="Gemini 3.5 Flash-Lite (Google)",
        provider=ProviderType.GOOGLE,
        ...
        description="Gemini 3.5 Flash-Lite — sous-agents, documents et haut débit, 1M contexte (sortie $2.50/M)",
        badge="Économique",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling", "reasoning", "cheap_text", "long_context"}),
    ),
    "gemini-3.1-flash-lite": ModelConfig(
        ...
        description="Gemini 3.1 Flash-Lite — modèle stable à faible latence pour extraction et tâches fréquentes, 1M contexte",
        badge="Rapide",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling", "reasoning", "cheap_text", "long_context"}),
    ),
    "gemini-2.5-flash-lite": ModelConfig(
        name="gemini-2.5-flash-lite",
        display_name="Gemini 2.5 Flash-Lite (Google)",
        provider=ProviderType.GOOGLE,
        ...
        supports_tools=True,
        cost_per_million_tokens=0.10,
        description="Gemini 2.5 Flash-Lite — classification et extraction économique à très faible latence, 1M contexte",
        badge="Économique",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling", "reasoning", "cheap_text", "long_context"}),
    ),
    ...
    "kimi-k3": ModelConfig(
        ...
        supports_video_generation=False,
        cost_per_million_tokens=3.0,
        description="Kimi K3 — flagship Moonshot pour code agentique, raisonnement et travail long, 1M contexte, vision image/vidéo en entrée",
        badge="Frontier",
        capabilities=frozenset({"vision_describe", "tool_calling", "reasoning", "long_context", "code_generation"}),
    ),
    ...
    "grok-4.6": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=2.0,
        description="Grok 4.6 — frontier xAI pour code, agents et travail professionnel (sortie $6/M)",
        badge="Frontier",
        capabilities=frozenset({"vision_describe", "tool_calling", "reasoning", "long_context", "code_generation"}),
    ),
    "grok-4.5": ModelConfig(
        name="grok-4.5",
        display_name="Grok 4.5 (xAI)",
        provider=ProviderType.XAI,
        model_id="grok-4.5",
        context_window=500_000,
        max_output_tokens=131_072,
        ...
        supports_tools=True,
        cost_per_million_tokens=2.0,
        description="Grok 4.5 — modèle xAI de code agentique, ingénierie et workflows (sortie $6/M)",
        badge="Code",
        capabilities=frozenset({"vision_describe", "tool_calling", "reasoning", "long_context", "code_generation"}),
    ),
    "grok-build-0.1": ModelConfig(
        name="grok-build-0.1",
        display_name="Grok Build 0.1 (xAI)",
        provider=ProviderType.XAI,
        ...
        supports_tools=True,
        cost_per_million_tokens=1.0,
        description="Grok Build 0.1 — modèle xAI rapide spécialisé dans les workflows de codage agentique (sortie $2/M)",
        badge="Code",
        capabilities=frozenset({"vision_describe", "tool_calling", "reasoning", "long_context", "code_generation"}),
    ),
    ...
    "grok-4.20-0309-reasoning": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=1.25,
        description="Grok 4.20 — raisonnement avec 1M contexte (sortie $2.50/M)",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling", "computer_use"}),
    ),
    "grok-4.20-0309-non-reasoning": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=1.25,
        description="Grok 4.20 — réponses directes, 1M contexte (sortie $2.50/M)",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling", "computer_use"}),
    ),
    "grok-4.20-multi-agent-0309": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=1.25,
        description="Grok 4.20 — optimisé multi-agents, 1M contexte (sortie $2.50/M)",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling", "computer_use"}),
    ),
    ...
    "glm-5.2": ModelConfig(
        ...
        description="GLM-5.2 — flagship Z.AI, 1M context, 128K output, tools and structured output",
        badge="Nouveau",
        capabilities=frozenset({"tool_calling", "reasoning", "long_context"}),
    ),
    "glm-5": ModelConfig(
        name="glm-5",
        ...
        description="GLM-5 — Z.AI general reasoning and tool-calling model",
        capabilities=frozenset({"tool_calling", "reasoning", "long_context"}),
    ),
    "glm-5-turbo": ModelConfig(
        ...
        description="GLM-5 Turbo — faster GLM-5 variant for tool-driven work",
        capabilities=frozenset({"tool_calling", "reasoning", "long_context"}),
    ),
    "glm-5.1": ModelConfig(
        name="glm-5.1",
    ...
    "glm-4.7": ModelConfig(
        ...
        description="GLM-4.7 — balanced Z.AI text, reasoning and tool model",
        capabilities=frozenset({"tool_calling", "reasoning", "long_context"}),
    ),
    ...
    "glm-4.6": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.60,
        description="GLM-4.6 — Z.AI reasoning and tool-calling model",
        capabilities=frozenset({"tool_calling", "reasoning", "long_context"}),
    ),
    "glm-4.5": ModelConfig(
        name="glm-4.5",
        ...
        supports_tools=True,
        cost_per_million_tokens=0.60,
        description="GLM-4.5 — Z.AI reasoning and coding model",
        capabilities=frozenset({"tool_calling", "reasoning"}),
    ),
    "glm-4.5-x": ModelConfig(
        name="glm-4.5-x",
        display_name="GLM-4.5 X (Z.AI)",
        provider=ProviderType.ZAI,
        model_id="glm-4.5-x",
        context_window=128_000,
        max_output_tokens=96_000,
        supports_tools=True,
        cost_per_million_tokens=2.20,
        description="GLM-4.5 X — premium Z.AI GLM-4.5 variant",
        capabilities=frozenset({"tool_calling", "reasoning"}),
    ),
    "glm-4.5-air": ModelConfig(
        ...
        description="GLM-4.5 Air — low-cost Z.AI GLM-4.5 variant",
        capabilities=frozenset({"tool_calling", "cheap_text"}),
    ),
    "glm-4.5-airx": ModelConfig(
        name="glm-4.5-airx",
        display_name="GLM-4.5 AirX (Z.AI)",
        provider=ProviderType.ZAI,
        ...
        supports_tools=True,
        cost_per_million_tokens=1.10,
        description="GLM-4.5 AirX — enhanced GLM-4.5 Air variant",
        capabilities=frozenset({"tool_calling", "reasoning"}),
    ),
    "glm-4-32b-0414-128k": ModelConfig(
        name="glm-4-32b-0414-128k",
        display_name="GLM-4 32B 0414 128K (Z.AI)",
        provider=ProviderType.ZAI,
        ...
        supports_tools=True,
        cost_per_million_tokens=0.10,
        description="GLM-4 32B 0414 128K — low-cost long-context Z.AI model",
        capabilities=frozenset({"tool_calling", "cheap_text", "long_context"}),
    ),
    ...
    "glm-4.6v": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.30,
        description="GLM-4.6V — multimodal Z.AI model for image, video and file understanding",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling"}),
    ),
    "glm-4.6v-flashx": ModelConfig(
        name="glm-4.6v-flashx",
        display_name="GLM-4.6V FlashX (Z.AI)",
        provider=ProviderType.ZAI,
        ...
        description="GLM-4.6V FlashX — low-cost multimodal Z.AI model",
        capabilities=frozenset({"vision_describe", "tool_calling", "cheap_text"}),
    ),
    "glm-4.5v": ModelConfig(
        name="glm-4.5v",
        display_name="GLM-4.5V (Z.AI)",
        provider=ProviderType.ZAI,
        model_id="glm-4.5v",
        context_window=128000,
        max_output_tokens=16000,
        ...
        supports_tools=True,
        cost_per_million_tokens=0.60,
        description="GLM-4.5V — multimodal Z.AI model for image, video and file understanding",
        capabilities=frozenset({"vision_describe", "vision_grounding", "tool_calling"}),
    ),
    "glm-ocr": ModelConfig(
        name="glm-ocr",
        display_name="GLM OCR (Z.AI)",
        provider=ProviderType.ZAI,
        model_id="glm-ocr",
        context_window=32000,
        ...
        description="GLM OCR — low-cost Z.AI optical character recognition model",
        capabilities=frozenset({"vision_describe", "ocr", "cheap_text"}),
    ),
...
MODEL_SKILLS: Dict[str, Dict[str, int]] = {
    ...
    "claude-sonnet-5":             {"code": 92, "speed": 66, "reasoning": 92, "creative": 95, "research": 91, "vision": 95, "web": 93},
    ...
    "gemini-2.5-flash-lite":       {"code": 70, "speed": 94, "reasoning": 68, "creative": 66, "research": 76, "vision": 82, "web": 80},
    ...
    "glm-4.7":                     {"code": 82, "speed": 76, "reasoning": 82, "creative": 76, "research": 76, "vision":  0, "web": 72},
    ...
    "glm-4.6":                     {"code": 80, "speed": 74, "reasoning": 80, "creative": 74, "research": 74, "vision":  0, "web": 70},
    "glm-4.5":                     {"code": 78, "speed": 70, "reasoning": 80, "creative": 72, "research": 72, "vision":  0, "web": 68},
    "glm-4.5-x":                   {"code": 80, "speed": 62, "reasoning": 82, "creative": 74, "research": 74, "vision":  0, "web": 70},
    "glm-4.5-air":                 {"code": 72, "speed": 86, "reasoning": 68, "creative": 66, "research": 64, "vision":  0, "web": 60},
    "glm-4.5-airx":                {"code": 76, "speed": 78, "reasoning": 74, "creative": 70, "research": 68, "vision":  0, "web": 64},
    "glm-4-32b-0414-128k":         {"code": 68, "speed": 82, "reasoning": 64, "creative": 60, "research": 62, "vision":  0, "web": 58},
    "glm-4.5-flash":               {"code": 70, "speed": 95, "reasoning": 64, "creative": 64, "research": 62, "vision":  0, "web": 60},
    "glm-4.6v":                    {"code": 70, "speed": 74, "reasoning": 72, "creative": 72, "research": 68, "vision": 82, "web": 68},
    "glm-4.6v-flashx":             {"code": 64, "speed": 88, "reasoning": 64, "creative": 66, "research": 62, "vision": 76, "web": 62},
    "glm-4.6v-flash":              {"code": 60, "speed": 90, "reasoning": 62, "creative": 65, "research": 60, "vision": 72, "web": 58},
    "glm-4.5v":                    {"code": 68, "speed": 70, "reasoning": 70, "creative": 72, "research": 66, "vision": 80, "web": 66},
    "glm-ocr":                     {"code": 42, "speed": 94, "reasoning": 40, "creative": 40, "research": 42, "vision": 70, "web": 42},
    ...
    "gpt-5.6-terra":               {"code": 96, "speed": 82, "reasoning": 96, "creative": 92, "research": 96, "vision": 97, "web": 96},
    "gpt-5.6-luna":                {"code": 90, "speed": 82, "reasoning": 90, "creative": 86, "research": 92, "vision": 94, "web": 92},
