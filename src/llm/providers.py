...
AVAILABLE_MODELS: Dict[str, ModelConfig] = {
    ...
    "nvidia-kimi-k2-instruct": ModelConfig(
        ...
        description="Kimi K2 Instruct — coding + agentic, gratuit via NVIDIA NIM. ⚠️ Serveurs souvent saturés : latence élevée possible.",
        badge="Gratuit",
        capabilities=frozenset({"tool_calling", "cheap_text"}),
    ),
    "nvidia-kimi-k2-instruct-0905": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.0,
        description="Kimi K2 Instruct 0905 — long-context + reasoning, gratuit via NVIDIA NIM. ⚠️ Serveurs souvent saturés : latence élevée possible.",
        badge="Gratuit",
        capabilities=frozenset({"tool_calling", "cheap_text"}),
    ),
    "nvidia-kimi-k2-thinking": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.0,
        description="Kimi K2 Thinking — raisonnement avancé 256K, gratuit via NVIDIA NIM. ⚠️ Serveurs souvent saturés : latence élevée possible.",
        badge="Gratuit",
        capabilities=frozenset({"tool_calling", "cheap_text"}),
    ),
    "nvidia-deepseek-v3.2": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.0,
        description="DeepSeek V3.2 685B — reasoning + agentic, gratuit via NVIDIA NIM. ⚠️ Serveurs souvent saturés : latence élevée possible.",
        badge="Gratuit",
        capabilities=frozenset({"tool_calling", "cheap_text"}),
    ),
    "nvidia-deepseek-v3.1": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.0,
        description="DeepSeek V3.1 Instruct — fast reasoning + tool use, gratuit via NVIDIA NIM. ⚠️ Serveurs souvent saturés : latence élevée possible.",
        badge="Gratuit",
        capabilities=frozenset({"tool_calling", "cheap_text"}),
    ),
    ...
    "nvidia-minimax-m2.5": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.0,
        description="MiniMax M2.5 via NVIDIA NIM — préférer MiniMax natif si MINIMAX_API_KEY configuré. ⚠️ Serveurs souvent saturés : latence élevée possible.",
        badge="Gratuit",
        capabilities=frozenset({"vision_describe", "tool_calling", "cheap_text"}),
    ),

    # === NVIDIA NIM — DeepSeek V4 (Free Endpoint) ===
    "nvidia-deepseek-v4-flash": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.0,
        description="DeepSeek V4-Flash 284B MoE — 1M contexte, coding + agents, gratuit via NVIDIA NIM. ⚠️ Serveurs souvent saturés : latence élevée possible.",
        badge="Gratuit",
    ...
    "nvidia-deepseek-v4-pro": ModelConfig(
        ...
        supports_tools=True,
        cost_per_million_tokens=0.0,
        description="DeepSeek V4-Pro — 1M contexte, MoE efficace, coding SOTA, gratuit via NVIDIA NIM. ⚠️ Serveurs souvent saturés : latence élevée possible.",
        badge="Gratuit",
...
MODEL_SKILLS: Dict[str, Dict[str, int]] = {
    ...
    "nvidia-deepseek-v4-flash":    {"code": 88, "speed": 82, "reasoning": 88, "creative": 72, "research": 82, "vision":  0, "web": 76},
    "nvidia-deepseek-v4-pro":      {"code": 94, "speed": 55, "reasoning": 94, "creative": 75, "research": 90, "vision":  0, "web": 80},
    # ── MiniMax (natif) ────────────────────────────────────────────────────
