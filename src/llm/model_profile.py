...
_MODEL_OVERRIDES: Dict[str, ModelBehaviorProfile] = {
    ...
    # NVIDIA NIM free endpoints used as model-level fallbacks.
    "nvidia-deepseek-v4-flash": ModelBehaviorProfile(
        parser_severity="lenient",
        thought_leak_risk="medium",
        action_inline_risk="low",
        loop_risk="low",
    ...
    "nvidia-deepseek-v4-pro": ModelBehaviorProfile(
        parser_severity="lenient",
        thought_leak_risk="medium",
        action_inline_risk="low",
        loop_risk="low",
        ...
        empty_response_risk="rare",
        retry_on_empty=True,
        timeout_multiplier=1.20,
        compact_ctx_threshold=0.74,
        file_section_threshold=120_000,
        sub_agent_iter_cap=45,
    ),
    "nvidia-gpt-oss-120b": ModelBehaviorProfile(
        parser_severity="strict",
        thought_leak_risk="medium",
        action_inline_risk="low",
        loop_risk="low",
    ...
    "nvidia-step-3.7-flash": ModelBehaviorProfile(
        parser_severity="lenient",
        thought_leak_risk="low",
        action_inline_risk="medium",
        loop_risk="low",
    ...
    "nvidia-kimi-k2.6": ModelBehaviorProfile(
        parser_severity="forgiving",
        thought_leak_risk="high",
        action_inline_risk="high",
        loop_risk="medium",
    ...
    "nvidia-glm-5.1": ModelBehaviorProfile(
        parser_severity="lenient",
        thought_leak_risk="low",
        action_inline_risk="medium",
        loop_risk="low",
    ...
    "nvidia-nemotron-3-ultra-550b-a55b": ModelBehaviorProfile(
        parser_severity="strict",
        thought_leak_risk="medium",
        action_inline_risk="low",
        loop_risk="low",
        ...
        compact_ctx_threshold=0.72,
    ),
    "nvidia-minimax-m2.7": ModelBehaviorProfile(
        parser_severity="lenient",
        thought_leak_risk="low",
        action_inline_risk="low",
        loop_risk="low",
    ...
    "nvidia-minimax-m3": ModelBehaviorProfile(
        parser_severity="lenient",
        thought_leak_risk="low",
        action_inline_risk="low",
        loop_risk="low",
    ...
    "nvidia-gemma-4-31b-it": ModelBehaviorProfile(
        parser_severity="lenient",
        thought_leak_risk="medium",
        action_inline_risk="medium",
        loop_risk="low",
    ...
    "qwen2.5-coder": ModelBehaviorProfile(
        parser_severity="forgiving",
        thought_leak_risk="medium",
        action_inline_risk="medium",
        loop_risk="medium",
        ...
        retry_on_empty=True,
        timeout_multiplier=1.35,
        compact_ctx_threshold=0.66,
        file_section_threshold=45_000,
        sub_agent_iter_cap=25,
    ),
    "llama3": ModelBehaviorProfile(
        parser_severity="forgiving",
        thought_leak_risk="high",
        action_inline_risk="high",
        loop_risk="medium",
        ...
        empty_response_risk="occasional",
        retry_on_empty=True,
        timeout_multiplier=1.45,
        compact_ctx_threshold=0.62,
        file_section_threshold=30_000,
        sub_agent_iter_cap=18,
    ),
    "gemma3": ModelBehaviorProfile(
        parser_severity="forgiving",
        thought_leak_risk="high",
        action_inline_risk="high",
        loop_risk="high",
