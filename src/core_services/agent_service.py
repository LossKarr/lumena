...
class AgentService:
    ...
    def _match_model_alias(self, message: str) -> Optional[str]:
        ...
        aliases = {
            ...
            "nvidia": "nvidia-kimi-k2-instruct",
            "nvidia kimi": "nvidia-kimi-k2-instruct",
            "nvidia thinking": "nvidia-kimi-k2-thinking",
            "nvidia reasoner": "nvidia-kimi-k2-thinking",
            "kimi k2": "nvidia-kimi-k2-instruct",
            "nvidia deepseek": "nvidia-deepseek-v3.2",
            ...
            "nvidia minimax": "nvidia-minimax-m2.5",
            "minimax m2": "nvidia-minimax-m2.5",
    ...
    async def _llm_extract_facts(self, user_message: str, response: str):
        ...
        prompt = self._LLM_FACT_EXTRACT_PROMPT.format(
