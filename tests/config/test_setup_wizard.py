...
class TestBatch3WelcomeTools:
    ...
    def test_no_hardcoded_340_in_index(self):
        index = Path(__file__).resolve().parent.parent.parent / "web" / "index.html"
...
class TestBatch4AgentKeywordsAccents:
    ...
    def test_accented_keywords_in_source(self):
        src = Path(__file__).resolve().parent.parent.parent / "web" / "routes" / "lifespan.py"
...
class TestBatch4PreflightAsync:
    ...
    def test_preflight_uses_to_thread(self):
        src = Path(__file__).resolve().parent.parent.parent / "web" / "routes" / "system.py"
        content = src.read_text(encoding="utf-8")
...
class TestBatch4AnthropicProbeReadonly:
    ...
    def test_anthropic_probe_is_get(self):
        src = Path(__file__).resolve().parent.parent.parent / "web" / "routes" / "setup.py"
        content = src.read_text(encoding="utf-8")
...
class TestBatch4VouvoiementFix:
    ...
    def test_no_vouvoiement_in_restart(self):
        src = Path(__file__).resolve().parent.parent.parent / "web" / "static" / "js" / "setup.js"
        content = src.read_text(encoding="utf-8")
...
class TestBatch5NoCharlesRegex:
    ...
    def test_no_charles_in_config(self):
        src = Path(__file__).resolve().parent.parent.parent / "web" / "routes" / "config.py"
        content = src.read_text(encoding="utf-8")
...
class TestBatch6Accessibility:
    ...
    def test_dialog_role_on_overlay(self):
        ...
        src = Path(__file__).resolve().parent.parent.parent / "web" / "index.html"
        content = src.read_text(encoding="utf-8")
    ...
    def test_responsive_css(self):
        ...
        src = Path(__file__).resolve().parent.parent.parent / "web" / "static" / "css" / "setup.css"
        content = src.read_text(encoding="utf-8")
...
class TestBatch7Chat503Detail:
    ...
    def test_chat_reads_detail_on_error(self):
        src = Path(__file__).resolve().parent.parent.parent / "web" / "static" / "js" / "chat.js"
        content = src.read_text(encoding="utf-8")
